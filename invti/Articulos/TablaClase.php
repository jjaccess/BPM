...
$query = mysqli_query($mysqli,"SELECT invti_clasearticulos.id id, invti_clasearticulos.clase clase, 
invti_articulos.articulo id_articulo 
FROM invti_clasearticulos,invti_articulos 
WHERE clase LIKE '%'
AND invti_clasearticulos.id_art = invti_articulos.id
ORDER BY id_articulo, clase
");
      ...
      onclick="agregaDato('<?php echo $data['id'] ?>','<?php echo $data['clase'] ?>')">
