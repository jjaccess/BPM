...
function miFuncion() {
	$('#tablaCategoriaLoad').load("TablaMarca.php");
		}
        ...
        <form id="frmCategorias">
			...
			<select  class="form-control input-sm" name="id_tipoart" id="id_tipoart">
							...
							<?php
                                                            ...
                                                            $query1 = $mysqli -> query ("SELECT id, articulo FROM invti_articulos ORDER BY articulo");
		...
		$(document).ready(function(){
			$('#btnActualizaCategoria').click(function(){
				...
				$.ajax({
					type:"POST",
					data:datos,
					url:"procesos/actualizaMarca.php",
					success:function(r){
						if(r==1){
							$('#tablaCategoriaLoad').load("TablaMarca.php");
		...
		function eliminaCategoria(idcategoria){
			alertify.confirm('¿Desea eliminar esta Marca?', function(){ 
				$.ajax({
					...
					url:"procesos/eliminarMarca.php",
					success:function(r){
						if(r==1){
							$('#tablaCategoriaLoad').load("TablaMarca.php");
