...
<table class='table table-striped table-bordered table-light' id='mitabla' style="text-align: center;" cellspacing="0" width="100%">
		<thead class="thead-dark">
                ...
                <tbody>
                    ...
                    $query = mysqli_query($mysqli,"SELECT invti_articulos.id id, invti_articulos.articulo articulo, invti_tipoart.tipo id_tipoart
                                    FROM invti_articulos, invti_tipoart
                                   WHERE articulo LIKE '%'
                                   AND invti_articulos.id_tipoart = invti_tipoart.id
                                   ORDER BY id_tipoart, articulo
