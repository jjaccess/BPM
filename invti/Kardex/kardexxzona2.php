...
<div class="container">
	<div class="row">
        <div class="col-sm-12">
<form class="form-inline formulariolinea" action="kardexxzona2.php" method="get" autocomplete="off" style="text-align: center;">
	...
	<h2 class="text-primary">
		...
		<div class="form-group">
			<a href="kardexxzona3.php" class="btn btn-success btn-xs"><span class="glyphicon glyphicon-list-alt" ></span> <span>Disponible x cantidad</span></a>
		</div>			
		&nbsp;&nbsp;&nbsp;	
		<div class="form-group">
			<a href="kardexxzona4.php" class="btn btn-warning btn-xs"><span class="glyphicon glyphicon-list-alt" ></span> <span>Detallado factura</span></a>
		</div>		
		</div>
