...
<div class="container">
	<div class="row">
        <div class="col-sm-12">
<form class="form-inline formulariolinea" action="kardexxpersona2.php" method="GET" style="text-align: center;">
		...
		&nbsp;&nbsp;
		<div class="form-group">
			<a href="kardexxpersona2_1.php" class="btn btn-success btn-xs"><span class="glyphicon glyphicon-list-alt" ></span> <span>Disponible x cantidad</span></a>
		</div>		
		&nbsp;&nbsp;
		<div class="form-group">
			<a href="kardexxpersona2_2.php" class="btn btn-warning btn-xs"><span class="glyphicon glyphicon-list-alt" ></span> <span>Detallado factura</span></a>
		</div>					
	</div>
  </form><br>
