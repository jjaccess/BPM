...
<div class="container">
	<div class="row">
        <div class="col-sm-12">
<form class="form-inline formulariolinea" action="reporte_confir_activos.php" method="GET" style="text-align: center;">
...
U.nombre Nombre, 
U.correo correo,
C.fechareg fecharegistro,
MONTHNAME(C.fechareg) AS Mes
FROM confir_activos AS C
INNER JOIN usuarios AS U
ON U.usuario =  C.usuario
WHERE fechareg BETWEEN '" . $fechaini . "' AND '" . $fechafin . "'  
				");
