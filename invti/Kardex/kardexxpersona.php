...
<div class="container">
	<div class="row">
        <div class="col-sm-12">
<form class="form-inline formulariolinea" action="kardexxpersona.php" method="GET" style="text-align: center;">
<div class="form-group">
		...
		<h2 class="text-primary">
			...
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<div class="form-group">
			<a href="kardexxpersona_1.php" class="btn btn-success btn-xs"><span class="glyphicon glyphicon-list-alt" ></span> <span>Disponible x cantidad</span></a>
		</div>
	</div>
</form><br>
