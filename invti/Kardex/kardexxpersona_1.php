...
<body>
 ...
 <form class="form-inline" action="kardexxpersona_1.php" method="get" style="text-align: center;">
	 ...
	 <h2 class="text-primary">
		...
		<input type="hidden" id="busqueda" name="busqueda" value="<?php echo utf8_decode($rowuser['usuario']);?>" readonly='readonly'>&nbsp;&nbsp;
