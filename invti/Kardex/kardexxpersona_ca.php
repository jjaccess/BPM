...
<div class="container">
	<div class="row">
        <div class="col-sm-12">
<form class="form-inline formulariolinea" action="kardexxpersona_ca.php" method="GET" style="text-align: center;">
<div class="form-group">
		<input name="busqueda" id="busqueda" type="hidden" class="form-control" value="<?php echo utf8_decode($rowuser['usuario']);?>" readonly='readonly'>&nbsp;&nbsp;
		<h2 class="text-primary">
			...
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<div class="form-group">
			<a href="#" class="btn btn-warning btn-xs" onclick="confirmactivos();"><i class="far fa-check-square"></i> <span>Confirmar</span></a>
		</div>
	</div>
</form><br>
	...
	<tr style="text-align: center;">
		...
		<!--consulta filtra registros por responsable-->
			<?php
				...
				SELECT invti_responsables.FECHAREGISTRO fechareg,
  ...
  function confirmactivos()
{
	...
	swal({
  title: "Confirmar activos",
  text: "Al confirmar usted será el responsable de dichos artículos.",
  icon: "warning",
  buttons: true,
  dangerMode: true,
})
