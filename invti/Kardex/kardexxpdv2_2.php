...
<div class="container">
	<div class="row">
        <div class="col-sm-12">
<form class="form-inline formulariolinea" action="kardexxpdv2_2.php" method="get" style="text-align: center;">
...
<?php  
	...
	//Paginador
			...
			FROM invti_puntosventa, puntosdeventa, empresas, invti_tipoart, invti_articulos, invti_marca, clasificaciones, proveedores
