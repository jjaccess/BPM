...
<div class="container">
	<div class="row">
        <div class="col-sm-12">
<form class="form-inline formulariolinea" action="kardexxpdv2.php" method="get" style="text-align: center;">
		...
		<h2 class="text-primary">
    		...
    		<input name="busqueda" id="busqueda" type="text" class="form-control" placeholder='Ingrese Codigo PV'>&nbsp;&nbsp;
	    <div class="form-group">
		<button type="submit" value="Buscar" class="btn btn-primary">Consultar</button>
		</div>
		&nbsp;&nbsp;
		<div class="form-group">
			<a href="kardexxpdv2_1.php" class="btn btn-success btn-xs"><span class="glyphicon glyphicon-list-alt" ></span> <span>Disponible x cantidad</span></a>
		</div>
		&nbsp;&nbsp;
		<div class="form-group">
			<a href="kardexxpdv2_2.php" class="btn btn-warning btn-xs"><span class="glyphicon glyphicon-list-alt" ></span> <span>Detallado factura</span></a>
		</div>										
	</div>
  </form><br>
<?php  
