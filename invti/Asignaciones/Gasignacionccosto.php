 ...
 //  $resultado2 = mysqli_query($mysqli,$consulta2);
   $resultado3 = mysqli_query($mysqli,$consulta3);
		...
		mysqli_close($mysqli);
	      ...
	      echo "window.location = 'asignacionresponsable.php';";
	      echo "</script>";
		//echo "Datos ingresados correctamente";
        //echo "<meta http-equiv='Refresh' content='5;url=asignacionresponsable.php'>";	
	}
	else {
		
		$mensaje2 = "Lo sentimos, este articulo no puede ser trasladado, ya que no se encuentra en buen estado.";
				echo "<script>";
				 echo "confirm('$mensaje2');";
				 	      echo "window.location = 'asignacionresponsable.php';";
		echo "</script>"; 
	}
	?>	
