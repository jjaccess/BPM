...
$consulta2 =   "UPDATE invti_puntosventa 
                SET sucursal = '" . $destino . "', 
                       origen = '" . $user . "',
					   user = '" . $user . "',
					   consecutivo = '" . $id . "',
					   asigna = 'N',
...
$sqldependencia = "SELECT nombre from puntosdeventa where COD = '" . $destino . "'";
...
$asunto = "Notificaciones BPM-Control activos";
			//Destino
      $cuerpo_A = "<p>Se&ntilde;or(a): $nombre_des,</p>  Se informa que usted, ha realizado un TRASLADO a la dependencia $ndependencia. - activo fijo $activo <p></p><p></p><p>Cordialmente,</p><p><p></p>Notificaciones BPM-Control activos</p>";
   ...
   $resultado3 = mysqli_query($mysqli,$consulta3);
		...
		$mensaje = "Datos ingresados correctamente";
	      ...
	      echo "window.location = 'asignacionpuntoventa.php';";
	      echo "</script>";
		mysqli_close($mysqli);
		//echo "Datos ingresados correctamente";
        //echo "<meta http-equiv='Refresh' content='5;url=asignacionpuntoventa.php'>";	
