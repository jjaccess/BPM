...
<?php  
  ...
  $consulta ="SELECT 
          ...
          FROM invti_bodegas, empresas, invti_tipoart, invti_articulos, invti_marca,bodegas
...
?>
    ...
    <form action='Gtrasladobod_bod.php' method='get' id='formulario' name='formulario' onsubmit='return valida(this)' >
	

    <div class="container">
<div class="col-md-8 offset-md-3 mt-4">

          <a class="btn btn-primary" href='consulta_trasladosbod_bod.php' style="margin: 10px -90px 0px;">
        ...
        <div class="form-row">
          <div class="col-md-10 mb-3" style="margin-top: 10px; margin-bottom: 20px;">
            <label>Observacion Traslado:</label>
