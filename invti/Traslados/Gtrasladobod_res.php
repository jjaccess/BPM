<?php
 ...
 $origen = $_GET['origen'];	//bodega origen para el update
 $codbodega = $_GET['codbodega'];	//codigo bodega origen para el update
 $bodega = $_GET['bodega'];	//bodega origen para el update
 ...
 $sqldesmail = "SELECT correo FROM usuarios WHERE usuario = '" . $destino . "'";
 $resultdesmail = $mysqli->query($sqldesmail);
 $desmail = $resultdesmail->fetch_assoc();

 $sqldesname = "SELECT nombre FROM usuarios WHERE usuario = '" . $destino . "'";
 ...
 if($action=='aceptar'){
	$consulta1 =	"UPDATE invti_responsables 
	                 SET asigna = 'N',
					 fecharegistro = NOW(),
					 responsable = '" . $user . "',
					 user = '" . $user . "',
    ...
    $consulta2 =   "UPDATE invti_bodegas 
		 ...
		 $cuerpo_A1 = "<p>Se&ntilde;or(a): $nombre_ori,</p>  Se informa que $nombre_des, ha CONFIRMADO el traslado realizado desde su bodega con activo fijo: $activo <p></p><p></p><p>Cordialmente,</p><p><p></p>Notificaciones BPM-Control activos</p>";
   ...
   $resultado2 = mysqli_query($mysqli,$consulta2);
	...
	$mensaje = "Se acepto el traslado con éxito";
      ...
      echo "window.location = 'consulta_trasladosbod_res.php';";
      echo "</script>";
		mysqli_close($mysqli);
    ...
    $consulta3 =	"UPDATE invti_responsables 
	                 SET asigna = 'R',
					 fecharegistro = NOW(),
					 responsable = '" . $user . "',
					 user = '" . $user . "',
		...
		$cuerpo_R1 = "<p>Se&ntilde;or(a): $nombre_ori,</p>  Se informa que $nombre_des, ha RECHAZADO el traslado realizado desde su bodega con activo fijo: $activo <p></p><p></p><p>Cordialmente,</p><p><p></p>Notificaciones BPM-Control activos</p>";
