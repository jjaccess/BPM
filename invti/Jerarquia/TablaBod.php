...
<table class='table table-striped table-bordered table-light' id='mitabla' style="text-align: center;" cellspacing="0" width="100%">
		<thead class="thead-dark">
                ...
                <tbody>
                    ...
                    $query = mysqli_query($mysqli,"SELECT bodegas.id id, bodegas.COD COD, 
                    bodegas.NOMBRE NOMBRE, bodegas.RESPONSABLE user, usuarios.nombre RESPONSABLE, status.status ESTADO, bodegas.ESTADO idestado 
        ...
        ?>
            ...
            onclick="agregaDato('<?php echo $data['id'] ?>','<?php echo $data['COD']?>','<?php echo $data['user'] ?>','<?php echo $rowuser['usuario'] ?>')">
