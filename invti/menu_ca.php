...
<?php if($_SESSION['tipo_usuario']==1 ||  $_SESSION['tipo_usuario']==15) { ?>
  ...
  <path fill-rule="evenodd" d="M0 2.5A.5.5 0 0 1 .5 2H2a.5.5 0 0 1 .485.379L2.89 4H14.5a.5.5 0 0 1 .485.621l-1.5 6A.5.5 0 0 1 13 11H4a.5.5 0 0 1-.485-.379L1.61 3H.5a.5.5 0 0 1-.5-.5zM3.14 5l.5 2H5V5H3.14zM6 5v2h2V5H6zm3 0v2h2V5H9zm3 0v2h1.36l.5-2H12zm1.11 3H12v2h.61l.5-2zM11 8H9v2h2V8zM8 8H6v2h2V8zM5 8H3.89l.5 2H5V8zm0 5a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm-2 1a2 2 0 1 1 4 0 2 2 0 0 1-4 0zm9-1a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm-2 1a2 2 0 1 1 4 0 2 2 0 0 1-4 0z"/>
			...
			<?php if($_SESSION['tipo_usuario']==1  || $_SESSION['tipo_usuario']==3 || $_SESSION['tipo_usuario']==12 || $_SESSION['tipo_usuario']==13 || $_SESSION['tipo_usuario']==17 || $_SESSION['tipo_usuario']==11 || $_SESSION['tipo_usuario']==14 || $_SESSION['tipo_usuario']==15 || $_SESSION['tipo_usuario']==16) { ?>
			 ...
			 <div class="dropdown-menu" aria-labelledby="navbarDropdown">
			<?php if($_SESSION['tipo_usuario']==1  || $_SESSION['tipo_usuario']==3 || $_SESSION['tipo_usuario']==15) { ?>
			        	<a class="dropdown-item" href="#">1- Traslado a otra Bodega</a>
			<?php } ?>
			<?php if($_SESSION['tipo_usuario']==1  || $_SESSION['tipo_usuario']==3 || $_SESSION['tipo_usuario']==15) { ?>
						<a class="dropdown-item" href="#">1- Recibir de otra bodega</a>
			<?php } ?>
			<?php if($_SESSION['tipo_usuario']==1  || $_SESSION['tipo_usuario']==3 || $_SESSION['tipo_usuario']==15) { ?>
			        	<a class="dropdown-item" href="#">2- Traslado a responsable</a>
			<?php } ?>
			<?php if($_SESSION['tipo_usuario']==1  || $_SESSION['tipo_usuario']==3 || $_SESSION['tipo_usuario']==12 || $_SESSION['tipo_usuario']==13 || $_SESSION['tipo_usuario']==17 || $_SESSION['tipo_usuario']==11 || $_SESSION['tipo_usuario']==14 || $_SESSION['tipo_usuario']==15 || $_SESSION['tipo_usuario']==16) { ?>
						<a class="dropdown-item" href="#">2- Recibir de bodega</a>
			<?php } ?>
			<?php if($_SESSION['tipo_usuario']==1  || $_SESSION['tipo_usuario']==3 || $_SESSION['tipo_usuario']==12 || $_SESSION['tipo_usuario']==13 || $_SESSION['tipo_usuario']==17 || $_SESSION['tipo_usuario']==11 || $_SESSION['tipo_usuario']==14 || $_SESSION['tipo_usuario']==15 || $_SESSION['tipo_usuario']==16) { ?>
						<a class="dropdown-item" href=".#">3- Traslado a Puntos de venta y/o Dependencia (3)</a>
			<?php } ?>
					</div>
			    </li>
			<?php } ?>
			...
			<?php if($_SESSION['tipo_usuario']==1  || $_SESSION['tipo_usuario']==3 || $_SESSION['tipo_usuario']==12 || $_SESSION['tipo_usuario']==13 || $_SESSION['tipo_usuario']==17 || $_SESSION['tipo_usuario']==11 || $_SESSION['tipo_usuario']==14 || $_SESSION['tipo_usuario']==15 || $_SESSION['tipo_usuario']==16) { ?>
			 ...
			 <div class="dropdown-menu" aria-labelledby="navbarDropdown">
			<?php if($_SESSION['tipo_usuario']==1  || $_SESSION['tipo_usuario']==3 || $_SESSION['tipo_usuario']==12 || $_SESSION['tipo_usuario']==13 || $_SESSION['tipo_usuario']==17 || $_SESSION['tipo_usuario']==11 || $_SESSION['tipo_usuario']==14 || $_SESSION['tipo_usuario']==15 || $_SESSION['tipo_usuario']==16) { ?>
			        <a class="dropdown-item" href="#">3- Devolución a Responsable</a>
			<?php } ?>
			<?php if($_SESSION['tipo_usuario']==1  || $_SESSION['tipo_usuario']==3 || $_SESSION['tipo_usuario']==12 || $_SESSION['tipo_usuario']==13 || $_SESSION['tipo_usuario']==17 || $_SESSION['tipo_usuario']==11 || $_SESSION['tipo_usuario']==14 || $_SESSION['tipo_usuario']==15 || $_SESSION['tipo_usuario']==16) { ?>
					<a class="dropdown-item" href="#">2- Devolución a Bodega</a>
			<?php } ?>
			<?php if($_SESSION['tipo_usuario']==1  || $_SESSION['tipo_usuario']==3|| $_SESSION['tipo_usuario']==15) { ?>
					<a class="dropdown-item" href="#">1- Recibir devolución de Responsable</a>
			<?php } ?>
			        </div>
			    </li>
			<?php } ?>
