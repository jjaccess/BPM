	...
	<body>
			<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  				<div class="container">
						...
						<a class="nav-link" href="#" style="color: white"><span class="fas fa-user" style="color: #D3D3D3"></span> <?php echo ($row['nombre']); ?></a>
						<a class="nav-link" href="#" style="color: white"><span class="fas fa-database" style="color: #D3D3D3"></span> <?php echo ($rowempresa['empresa']); ?></a>
  				</div>
		    </nav>
			<p></p>		

    <nav class="navbar navbar-expand-lg navbar-lg static-top">
    <div class="container">
