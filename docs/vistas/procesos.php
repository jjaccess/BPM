...
?>
  ...
  <div class="container">
    <h1 class="display-6">Procesos</h1>
    ...
    <div class="row">
      <div class="col-sm-4">
        <span class="btn btn-primary" data-toggle="modal" data-target="#modalAgregaProceso">
          <span class="fas fa-plus-circle"></span> Agregar nuevo proceso
        </span>
      </div>
    </div>
    <hr>
...
?>
  ...
  <script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#mcprocesosLoad').load("mcprocesos/selectMcprocesos.php");
