...
if(!isset($_SESSION["id_usuario"])){
  ...
  $sql = "SELECT id_categoria, nombre FROM dc_categorias WHERE id_subproceso= '$dato'";
...
<div class="jumbotron jumbotron-fluid">
  ...
  <a href=""><span class="fas fa-address-card"></span> <?php echo ''.($row['nombre']); ?></a>
    ...
    <?php while($mostrar = mysqli_fetch_array($result)) {
                  ...
                  $idproceso = $mostrar['id_categoria'];
      ?>
     <div class="col-md-auto">
     <form id="frmCategorias" action="documentos_arc.php" method="GET">
