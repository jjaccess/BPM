<?php
	...
	if(!empty($_POST))
	{
		...
		$activo = 0;
		$tipo_usuario = 2;
		$secret = '6LfzsUoUAAAAAF45bnPKzS9A8NvoztzqvcXeImAp';
		...
		if(count($errors) == 0)
		{
			...
			if($arr['success'])
			{
				...
				if($registro > 0 )
				{
					...
					$url = 'http://'.$_SERVER["SERVER_NAME"].'/BPM/activar.php?id='.$registro.'&val='.$token;
					
					$asunto = 'Activar Cuenta - BPM';
					...
					<div class="panel-body" >
						...
						<form id="signupform" class="form-horizontal" role="form" action="<?php $_SERVER['PHP_SELF'] ?>" method="POST" autocomplete="off">
							...
							<div class="form-group">
								...
								<div class="g-recaptcha col-md-9" data-sitekey="6LfzsUoUAAAAALK-GVttL-c8fsjmlWe7ChYvV3vz"></div>
							</div>
